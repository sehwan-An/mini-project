        ...
        <Form noValidate validated={validated} onSubmit={handleSubmit}>
          ...
          <Row className="mb-3">
            <Form.Group as={Col} md="12" controlId="validationCustom03">
              ...
              <Form.Control type="tell" placeholder="연락처" required maxLength={15} 
            ...
            <Form.Group as={Col} md="12" controlId="validationCustom04">
              ...
              <Form.Control type="url" 
               ...
               name="sns"
               onChange={handleChange}
              placeholder="https://insta.com/your_channel" required />
              <Form.Control.Feedback type="invalid">
          ...
          <Row className='justify-content-center'><Col md='4'><Button type="submit" variant="success">완료</Button></Col></Row>
        </Form>
      </Container>
